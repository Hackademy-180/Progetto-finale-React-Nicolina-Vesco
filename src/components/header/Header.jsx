                ...
                <ul className='slider'>
                    ...
                    <li className='img2 item'>
                        <div className='content'>
                            ...
                            <p className='description !text-[0.9rem] font-semibold'> Sviluppato da Insomniac Games, Marvel’s Wolverine racconta la storia del celebre mutante Logan. Il gioco promette combattimenti intensi, una narrazione più matura e un gameplay dinamico che sfrutta gli iconici artigli di Wolverine. </p>
                            <button>Read More</button>
                        </div>
                    </li>
                    ...
                    <li className='img5 item'>
                        <div className='content'>
                            ...
                            <p className='description !text-[0.9rem] font-semibold'> Pragmata è un misterioso gioco sviluppato da Capcom ambientato in un futuro distopico. I giocatori esploreranno una stazione lunare insieme a una misteriosa ragazza androide mentre cercano di scoprire cosa è successo alla colonia umana.  </p>
                            <button>Read More</button>
                        </div>
                    </li>
                </ul>

            ...
            <header className="rev-header">
                ...
                <ul className='slider'>
                    ...
                    <li className='img1 item'>
                        <div className='content'>
                            <h2 className='title lg:text-3xl pt-5 md:pt-0 drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]'>Resident Evil 9</h2>
                    ...
                    <li className='img2 item'>
                        <div className='content'>
                            <h2 className='title pt-4 md:pt-0 lg:text-2xl'>Wolverine</h2>
                    ...
                    <li className='img3 item'>
                        <div className='content'>
                            <h2 className='title pt-3 md:pt-0 lg:text-3xl'>Mass Effect</h2>
                    ...
                    <li className='img4 item'>
                        <div className='content'>
                            <h2 className='title pt-4 md:pt-0 lg:text-2xl'>The Witcher IV</h2>
                            <p className='description'>
                    ...
                    <li className='img5 item'>
                        <div className='content'>
                            <h2 className='title pt-2 md:pt-0 lg:text-3xl'>Pragmata</h2>
